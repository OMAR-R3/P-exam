...
<script>
    ...
    <section id="global">
        ...
        <div class="caja-exam">
            ...
            <div class="caja-btn">
                <a href="crear_exam.php"><button>CREAR EXAMEN</button></a>
                <a href="elegir_exam.php"><button>ELEGIR EXAMEN</button></a>
                <a href="modificacion_exam.php"><button>MODIFICAR EXAMEN</button></a>
            </div>
        </div>    
        ...
        $conexion = mysqli_connect("localhost", "root", "", "examen") or die("Problemas con la conexion");
            ...
            $registros = mysqli_query($conexion, "select codigoAlumno,nombreAlumno,grado,grupo,turno,correo,aciertos,errores,calificacionAlumno,fecha,hora from calialum") or die("Problemas en el select:" . mysqli_error($conexion));
            $promedio=0;
            $alum=0;
        ...
        <div class="box-prom">
            <div class="promedio"><label>Promedio - Escuela: <?php echo $promescue;?></label></div>
        </div>
