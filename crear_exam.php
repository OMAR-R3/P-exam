...
<script>
    ...
    <section id="global">
        ...
        <div class="instruct">
            <p>Bienvenido profesor o profesora en este apartado puede hacer la creacion del examen, debe ingresar las preguntas y respuestas a modificar, como tambien debe elegir cual respuesta(s) estan correctas o incorrectas selecionando el radio de <label class="correct">✔</label> o <label class="inco">✖</label>.</p>
        </div>
        ...
        <?php
            ...
            if(isset($_POST["envioexam"])){
                include("procesar_creacion_exam.php");
            }
