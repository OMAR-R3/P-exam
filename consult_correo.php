...
<?php
    ...
    $registros = mysqli_query($conexion, "SELECT codigoAlumno,nombreAlumno,grado,grupo,turno,correo,aciertos,errores,calificacionAlumno,fecha,hora from calialum where correo='$corr'") or die("Problemas en el select:" . mysqli_error($conexion));

    $consulta="SELECT * FROM calialum where correo='$corr'";
